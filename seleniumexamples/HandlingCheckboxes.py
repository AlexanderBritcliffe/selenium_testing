...
#below code is while i becomes one or if 1 is present
...
driver.find_elements_by_name(By.NAME, "sports")
...
#reduced x path above to only whats needed so it remains a unique element
